-- Fix smtp_config table to match API expectations
-- Run this SQL script in your Supabase SQL editor to fix the table structure
-- Drop the existing table if it exists
DROP TABLE IF EXISTS public.smtp_config CASCADE;
-- Create smtp_config table with correct column names
